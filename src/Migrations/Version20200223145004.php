 ...
 */
final class Version20200223145004 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE container (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, name VARCHAR(255) NOT NULL, type SMALLINT NOT NULL, INDEX IDX_C7A2EC1B9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sequence (id INT AUTO_INCREMENT NOT NULL, n_modification_id_id INT DEFAULT NULL, c_modification_id_id INT DEFAULT NULL, b_modification_id_id INT DEFAULT NULL, container_id INT NOT NULL, type VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, formula VARCHAR(255) NOT NULL, mass DOUBLE PRECISION DEFAULT NULL, sequence VARCHAR(255) DEFAULT NULL, smiles VARCHAR(500) DEFAULT NULL, source SMALLINT DEFAULT NULL, identifier VARCHAR(255) DEFAULT NULL, decays VARCHAR(255) DEFAULT NULL, family VARCHAR(255) DEFAULT NULL, INDEX IDX_5286D72BF6B63604 (n_modification_id_id), INDEX IDX_5286D72B40E730A9 (c_modification_id_id), INDEX IDX_5286D72B25800BEF (b_modification_id_id), INDEX IDX_5286D72BBC21F742 (container_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE container ADD CONSTRAINT FK_C7A2EC1B9D86650F FOREIGN KEY (user_id_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE container DROP FOREIGN KEY FK_C7A2EC1B9D86650F');
